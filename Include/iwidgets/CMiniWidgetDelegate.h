#ifndef iwidgets_CMiniWidgetDelegate_included
#define iwidgets_CMiniWidgetDelegate_included
...
*/
class CMiniWidgetDelegate: virtual public IMultiPageWidgetDelegate
{
public:
	CMiniWidgetDelegate();
...
#endif // !iwidgets_CMiniWidgetDelegate_included
