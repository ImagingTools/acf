#ifndef iview_CInteractiveArrowShape_included
#define iview_CInteractiveArrowShape_included
...
class CInteractiveArrowShape: public CInteractiveShapeBase
{
public:
...
inline void CInteractiveArrowShape::EnsurePointsAreValid() const
{
	if (!m_arePointsValid){
...
inline void CInteractiveArrowShape::EnsurePointsAreValid(const i2d::CLine2d& line) const
{
	if (!m_arePointsValid){
		CalcPoints(line);
		m_arePointsValid = true;
...
#endif // !iview_CInteractiveArrowShape_included
