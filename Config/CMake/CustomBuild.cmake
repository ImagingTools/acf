...
if(ANDROID)
	set(ARXCBIN "${ACFDIR}/Bin/${CMAKE_BUILD_TYPE}_$ENV{ARXCHOST}/${ARX_COMPILER}")
	set(ACFBIN "${ACFDIR}/Bin/${CMAKE_BUILD_TYPE}_$ENV{ARXCHOST}/${ACF_TOOL}")
	set(ARXC_OUTFILE_NAME ${PROJECT_BINARY_DIR}/C${ARXC_FILES_NAME}.cpp)
else()
	set(ARXCBIN "${ACFDIR}/Bin/${CMAKE_BUILD_TYPE}_${TARGETNAME}/${ARX_COMPILER}")
	set(ACFBIN "${ACFDIR}/Bin/${CMAKE_BUILD_TYPE}_${TARGETNAME}/${ACF_TOOL}")
endif()
...
add_custom_command(OUTPUT ${ARXC_OUTFILE_NAME}
	COMMAND ${ARXCBIN}
	ARGS ${ARXC_FILES} -o ${ARXC_OUTFILE_NAME} -config ${ARXC_CONFIG} -conf_name ${CMAKE_BUILD_TYPE}_${TARGETNAME} -env_vars ${ENV_VARS} -v
